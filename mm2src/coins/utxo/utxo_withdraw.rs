...
use crate::utxo::{output_script, sat_from_big_decimal, ActualTxFee, Address, FeePolicy, ListUtxoOps, PrivKeyPolicy,
...
where
    Self: Sized + Sync,
    Coin: UtxoCommonOps + ListUtxoOps,
{
    fn coin(&self) -> &Coin;
...
where
    Coin: UtxoCommonOps + ListUtxoOps + UtxoSignerOps,
{
